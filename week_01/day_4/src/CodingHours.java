public class CodingHours {
  public static void main(String[] args) {
    ...
    float codingHourPercentage =
        attendeeCodingHoursPerSemester / (semesterWeeks * weeklyWorkingHours);
    int codingHourPercentageInt = (int) (codingHourPercentage * 100);
    System.out
        .println("Percentage of coding hours int the semester: " + codingHourPercentageInt + "%");
  }
}
