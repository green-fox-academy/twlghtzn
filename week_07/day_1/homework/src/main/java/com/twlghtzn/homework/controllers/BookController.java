package com.twlghtzn.homework.controllers;

import com.twlghtzn.homework.models.Book;
...
/*  @RequestMapping(path = "/books", method = RequestMethod.GET)
  ...
  @RequestMapping(path = "/books", method = RequestMethod.GET)
  public String showBooks(Model model, @RequestParam(name = "author", required = false)
      String author) {
